...
def crop_map_img(num):
    im = Image.open(fr"python/images/photo-expeditions/{num}_map.png")
    ...
    return save_loc
def generate_photo_expeditions_cards(): 
    data = pd.read_csv('python/csv/IN Data - Photo Expeditions.csv')
